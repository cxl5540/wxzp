   ...
   methods:{
    ...
    submit:function(){
       ...
       if(this.$route.query.type==='edit'){             //修改
        ...
        let _this = this;
        this.$http.post(_const.requestUrl+'/v1/userrecord/editWork',params).then(function ( res ){ 
              console.log(res);
              setTimeout(function(){                 
                _this.$dialog.toast({
                      mes: '保存成功',
                ...
                let paramsf = new URLSearchParams();
                  ...
                  this.$http.post(_const.requestUrl+'/v1/userrecord/findResume',paramsf).then(function ( res ){
                     if(res.list.base_id){
                      ...
                      _this.$http.post(_const.requestUrl+'/v1/userrecord/addWork',params).then(function ( res ){
                          console.log(res);
                          setTimeout(function(){                 
                            _this.$dialog.toast({
                                  mes: '添加成功',
