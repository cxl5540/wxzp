       ...
       // params.append('train_id', this.train_id);
        ...
        if(this.$route.query.type==='edit'){             //修改
            if(this.check()){
                params.append('train_id', this.train_id);
                let _this = this;
                this.$http.post(_const.requestUrl+'/v1/userrecord/editTrain',params).then(function ( res ){ 
                      console.log(res);
                      setTimeout(function(){                 
                        _this.$dialog.toast({
                              mes: '保存成功',
                  ...
                  if(this.check()){
                    ...
                    this.$http.post(_const.requestUrl+'/v1/userrecord/findResume',paramsf).then(function ( res ){
                       if(res.list.base_id){
                        ...
                        _this.$http.post(_const.requestUrl+'/v1/userrecord/addTrain',params).then(function ( res ){
                            console.log(res);
                            setTimeout(function(){                 
                              _this.$dialog.toast({
                                    mes: '添加成功',
