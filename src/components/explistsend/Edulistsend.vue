 ...
 this.findResume();
   ...
   methods:{
         ...
         return;
           ...
           this.$dialog.confirm({
            ...
            opts: () => {
                    ...
                    this.$http.post(_const.requestUrl+'/v1/userrecord/delEdcation',delparms).then(function ( res ){
    ...
    edit:function(index){   //编辑教育经验
       ...
       this.$router.push({name:'Editedusend',query:{ editTable:eduList,type:'edit',id:index,newbase_id:this.newbase_id} });
    },
    edu_add:function(){    //增加教育经验
         this.$router.push({name:'Editedusend',query: { type:'add',id:this.id,newbase_id:this.newbase_id} }); 
