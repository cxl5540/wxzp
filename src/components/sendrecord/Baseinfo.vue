...
<div>
  ...
  <div class="information">
        <yd-cell-group>
            ...
            <yd-cell-item>
             ...
             <yd-cell-item>
                ...
                <input slot="right" type="text"  v-model='sex' disabled>
            </yd-cell-item>
             <yd-cell-item>
                <span slot="left">年龄</span>
                <input slot="right" type="text"  v-model='age' disabled>
            </yd-cell-item>
        ...
        <yd-cell-item arrow type="label" >
            ...
            <select slot="right"  v-model="marriage" id="marriage" placeholder="请选择">
               <option value="">请选择</option>
            </select>
        </yd-cell-item>
        <yd-cell-item arrow type="label" >
             ...
             let _this=this;
                ...
                console.log(json_result);
                     if(json_result.RESPONSE.HEAD.RESULT=='1'){
                      ...
                      let wed=json_result.RESPONSE.LIST[0].WED;
                      var nation = $("#nations");               
                  ...
                          var name=wed[i].NAME; 
                          var num= wed[i].NUMBER;   
                          wedd.append("<option value='"+num+"'>"+name+"</option>"); 
                        }  
        ...
        /*     _this.sex=_this.baseList.sex;*/
            ...
            /* _this.age=_this.baseList.age;*/
             _this.reg_address=_this.baseList.reg_address;
               _this.uname=_this.baseList.name;
              _this.mobile=_this.baseList.mobile;
              _this.card_no=_this.baseList.card_no;
              _this.email=_this.baseList.email;
              _this.obj_id=_this.baseList.object_id;
  ...
  saveResume: function(){           //提交基础信息
    ...
    if(this.check()){
       ...
       $.ajax({
        ...
        console.log(data);
         let url =_const.requestUrl+'/v1/userrecord/saveResume';
      ...
      if(this.email.length == 0) {
        ...
        if(this.top_education==''){
          ...
          if(this.current_work_status == '') {
           ...
           if(this.native_place.length >40) {
            Toast({
              message: "籍贯字数不得超过40",
              duration: 1500
            });
