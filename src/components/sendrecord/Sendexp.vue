<template>
  <div class="experience" style="padding-top: 0.2rem">
    <div style="margin-top: 0">
      <router-link  :to="{path:'/Joblistsend',query:{id:this.id,objid:objid}}" exact >
        <div class="exp" >
          <div style='display: flex;line-height: 32px;' class="itemexp">
              ...
              <span style='font-weight: bold;'><i class="fa musticon">*</i>&nbsp;工作经历</span>
          </div>
          <div style='width: 11%'>
      ...
      <div class="noExp" v-show='noExp'>你还没有工作经验,请添加</div>
  ...
  <div>
  <router-link :to="{path:'/Prolistsend',query:{id:this.$route.query.id,objid:objid}}" slot="left">
      <div class="exp">
        <div style='display: flex;line-height: 32px' class="itemexp">
            <div style="width: 18px;margin-right:6px">
  ...
  <div>
    <router-link :to="{path:'/Tarinlistsend',query:{id:this.$route.query.id,objid:objid}}" slot="left">
        <div class="exp">
          <div style='display: flex;line-height: 32px;' class="itemexp">
              <div style="width: 18px;margin-right:6px">
  ...
  <div>
    <router-link :to="{path:'/Edulistsend',query:{id:this.$route.query.id,objid:objid}}">
        <div class="exp">
          <div style='display: flex;line-height: 32px;' class="itemexp">
              <div style="width: 18px;margin-right:6px">
  ...
  <div>
    <router-link  :to="{path:'/Certlistsend',query:{id:this.$route.query.id,objid:objid}}">
       <div class="exp">
          <div style='display: flex;line-height: 32px' class="itemexp">
              <div style="width: 18px;margin-right:6px">
  ...
  <div>
    <router-link  :to="{path:'/Lagulistsend',query:{id:this.$route.query.id,objid:objid}}">
      <div class="exp">
          <div style='display: flex;line-height: 32px;' class="itemexp">
              <div style="width: 18px;margin-right:6px">
       ...
       <div class="list" :data="laguForm.laguTableData" v-for="(item, index) in laguForm.laguTableData" :key="item.index">
          <div  v-for="(val,index) in item" :key="index">
           <div>
              ...
              <div class="fengexian">
                  <p style="padding-top: 10px;">听说:{{val.hearspeak}}&nbsp;/&nbsp;读写:{{val.readwrite_name}}</p>
              </div>        
           </div>         
        </div>     
      </div>
  ...
  <div>
   <router-link :to="{path:'/Skilllistsend',query:{id:this.$route.query.id,objid:objid}}">
      <div class="exp">
          <div style='display: flex;line-height: 32px;' class="itemexp">
              <div style="width: 18px;margin-right:6px">
  ...
  <div>
    <router-link :to="{path:'/Awardlistsend',query:{id:this.$route.query.id,objid:objid}}">
      <div class="exp">
          <div style='display: flex;line-height: 32px' class="itemexp">
              <div style="width: 18px;margin-right:6px">
 ...
 this.findResume();
   ...
   findResume(){
      let params = new URLSearchParams();
        params.append('job_id',this.msgid);
        let _this = this; 
      ...
      workList:function(){    // 工作列表    
        ...
        var paramsList=new URLSearchParams(); 
             paramsList.append('base_id',this.newbase_id);
              let _this = this;
            this.$http.post(_const.requestUrl+'/v1/userrecord/worklist',paramsList).then(function ( res ){            
              if(res.list.total==0){
                _this.noExp=true;
              }
                  ...
                  for(var i=0;i< _this.laguForm.laguTableData[0].length;i++){
                   if( _this.laguForm.laguTableData[0][i].hearspeak=='1'){
                    ...
                    if( _this.laguForm.laguTableData[0][i].readwrite=='1'){
                       _this.laguForm.laguTableData[0][i].readwrite_name='熟练';
                    }else if( _this.laguForm.laguTableData[0][i].readwrite=='2'){
                       _this.laguForm.laguTableData[0][i].readwrite_name='一般'
                    }else if ( _this.laguForm.laguTableData[0][i].readwrite=='0') {
                        _this.laguForm.laguTableData[0][i].readwrite_name='精通'
                    }
